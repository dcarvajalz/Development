...
graph export "hist_beta_total.png", replace
restore
...
graph export "hist_phi_total.png", replace
restore
...
gen nhh = _n 
gen inc_g = 0
replace inc_g = 1 if nhh<=576
replace inc_g = 2 if nhh>576 & nhh<=1152
replace inc_g = 3 if nhh>1152 & nhh<=1728
replace inc_g = 4 if nhh>1728 & nhh<=2304
replace inc_g = 5 if nhh>2304 & nhh<=2879
...
gen nhh = _n 
gen beta_g = 0
replace beta_g = 1 if nhh<=576
replace beta_g = 2 if nhh>576 & nhh<=1152
replace beta_g = 3 if nhh>1152 & nhh<=1728
replace beta_g = 4 if nhh>1728 & nhh<=2304
replace beta_g = 5 if nhh>2304 & nhh<=2879

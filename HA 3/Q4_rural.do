...
graph export "hist_beta_rural.png", replace
restore
...
graph export "hist_phi_rural.png", replace
restore
...
gen nhh = _n 
gen inc_g = 0
replace inc_g = 1 if nhh<=445
replace inc_g = 2 if nhh>445 & nhh<=890
replace inc_g = 3 if nhh>890 & nhh<=1335
replace inc_g = 4 if nhh>1335 & nhh<=1780
replace inc_g = 5 if nhh>1780 & nhh<=2226
...
gen nhh = _n 
gen beta_g = 0
replace beta_g = 1 if nhh<=445
replace beta_g = 2 if nhh>445 & nhh<=890
replace beta_g = 3 if nhh>890 & nhh<=1335
replace beta_g = 4 if nhh>1335 & nhh<=1780
replace beta_g = 5 if nhh>1780 & nhh<=2226
